<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Contacts.aspx.cs" Inherits="Contacts" %>
...
&nbsp;
    ...
    <asp:GridView ID="GridView1" runat="server" BackColor="White" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText ="Chat">
                <ItemTemplate>
                    <asp:LinkButton ID="Chat" runat ="server" ForeColor="Black"  CommandArgument='<%#Eval("Name2")%>' Text ="Chat" CommandName ="Chat" ></asp:LinkButton>
                    <ItemStyle Width="33%"></ItemStyle>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    ...
    <asp:GridView ID="GridView2" runat="server" BackColor="White" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText ="Chat">
                <ItemTemplate>
                    <asp:LinkButton ID="Chat0" runat ="server" ForeColor="Black" CommandArgument='<%#Eval("Name1")%>' Text ="Chat" CommandName ="Chat" ></asp:LinkButton>
                    <ItemStyle Width="33%"></ItemStyle>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
