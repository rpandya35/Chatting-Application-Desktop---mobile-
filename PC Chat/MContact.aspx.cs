...
public partial class MContact : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("SELECT CID, Name1, Image1 FROM PCContact WHERE (ID = '" + id + "')  Order By Name1 ", con);
        DataSet ds = new DataSet();
        da.Fill(ds);
        GridView1.DataSource = ds;
        GridView1.DataBind();

        da = new SqlDataAdapter("SELECT CID, Name2, Image2 FROM PCContact where Name1 = '" + Session["mname"].ToString() + "'  Order By Name2 ", con);
        ds = new DataSet();
        da.Fill(ds);
