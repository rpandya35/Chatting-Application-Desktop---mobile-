...
public partial class List : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("Select ID,Name1,Image1,Flag1,Name2,Image2,Flag2 from PCContact where ID = '" + Session["mid"].ToString() + "' OR Name1 = '" + Session["mname"].ToString() + "' Order By Name2", con);
        ...
        SqlCommand cmd = new SqlCommand("Update PCContact Set Flag2 = 'Yes' Where Flag2 = 'No' AND Name1 = '" + Session["mname"].ToString() + "'", con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
    }
    ...
    public void load(int cou,DataSet ds)
    {
        ...
        if (cou >= 1)
        {
            ...
            if (ds.Tables[0].Rows[0][6].ToString() == "No")
            {
                Mark1.Visible = true;
            }
            else
        ...
        if (cou >= 2)
        {
            ...
            if (ds.Tables[0].Rows[1][6].ToString() == "No")
            {
                Mark2.Visible = true;
            }
            else
        ...
        if (cou >= 3)
        {
            ...
            if (ds.Tables[0].Rows[2][6].ToString() == "No")
            {
                Mark3.Visible = true;
            }
            else
        ...
        if (cou >= 4)
        {
            ...
            if (ds.Tables[0].Rows[3][6].ToString() == "No")
            {
                Mark4.Visible = true;
            }
            else
        ...
        if (cou >= 5)
        {
            ...
            if (ds.Tables[0].Rows[4][6].ToString() == "No")
            {
                Mark5.Visible = true;
            }
            else
        ...
        if (cou >= 6)
        {
            ...
            if (ds.Tables[0].Rows[5][6].ToString() == "No")
            {
                Mark6.Visible = true;
            }
            else
        ...
        if (cou >= 7)
        {
            ...
            if (ds.Tables[0].Rows[6][6].ToString() == "No")
            {
                Mark7.Visible = true;
            }
            else
        ...
        if (cou >= 8)
        {
            ...
            if (ds.Tables[0].Rows[7][6].ToString() == "No")
            {
                Mark8.Visible = true;
            }
            else
        ...
        if (cou >= 9)
        {
            ...
            if (ds.Tables[0].Rows[8][6].ToString() == "No")
            {
                Mark9.Visible = true;
            }
            else
        ...
        if (cou >= 10)
        {
            ...
            if (ds.Tables[0].Rows[9][6].ToString() == "No")
            {
                Mark10.Visible = true;
            }
            else
    ...
    protected void Name10_Click(object sender, EventArgs e)
    {
